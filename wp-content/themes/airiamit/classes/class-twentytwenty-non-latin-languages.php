...
if ( ! class_exists( 'airiamit_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 */
	class airiamit_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'airiamit_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'airiamit_get_localized_font_family_elements',
				array(
			...
			return airiamit_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
